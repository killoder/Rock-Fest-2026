...
export function Slide04() {
  return (
    <div className="relative min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center overflow-hidden w-full font-['Inter_Tight',sans-serif] p-8">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center justify-center px-8">
        ...
        <div className="relative mb-12 sm:mb-16 transform -rotate-3 z-30 group">
          ...
          <h2 className="font-['Inter_Tight',sans-serif] font-black text-[11vw] sm:text-6xl md:text-7xl lg:text-8xl text-[#CCFF00] uppercase tracking-tighter leading-[0.8] text-center drop-shadow-[0_0_20px_rgba(204,255,0,0.5)]">
            2-DAYS OF <br />
        ...
        <div className="relative w-full flex flex-col md:flex-row items-center justify-center gap-10 sm:gap-8 h-auto">
            ...
            <div className="bg-[#FF4500] p-6 sm:p-8 shadow-[10px_10px_0px_#0A0A0A] border-4 border-[#0A0A0A] relative w-full max-w-md text-left">
              ...
              <div className="flex flex-col gap-2 items-start w-full">
                <div className="flex items-start">
                  ...
                  <h4 className="font-['Inter_Tight',sans-serif] font-black text-2xl sm:text-3xl text-[#0A0A0A] uppercase leading-[1.1] tracking-tight text-left">
                    Grupi Lynx
                  </h4>
                </div>
                <div className="flex items-start">
          ...
          {/* Day 2 Container */}
          <div className="relative z-20 w-full md:w-1/2 flex flex-col items-center sm:items-start justify-center sm:pl-4 rotate-[10deg] sm:-mt-10 hover:rotate-[0deg] transition-transform duration-300">
        ...
        {/* Support Acts */}
        <div className="relative w-full flex justify-center mt-6 z-30">
          <div className="bg-[#0A0A0A] border-2 border-[#00F0FF] p-4 sm:p-6 transform rotate-[-2deg] shadow-[6px_6px_0px_#00F0FF] hover:rotate-[0deg] transition-transform duration-300">
            ...
            <h5 className="font-['JetBrains_Mono',monospace] text-[#00F0FF] text-sm tracking-widest uppercase text-center mt-3">
              // Support //
            </h5>
          </div>
        </div>
