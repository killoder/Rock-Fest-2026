    ...
    <div className="relative min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center p-6 sm:p-12 md:p-24 overflow-hidden w-full font-['Inter_Tight',sans-serif]">
      ...
      <div className="relative z-10 w-full max-w-5xl flex flex-col items-center justify-center">
        ...
        <div className="mb-16 md:mb-20 text-center relative group">
          ...
          <h3 className="font-black text-5xl md:text-6xl lg:text-8xl text-[#FFFFFF] uppercase tracking-tighter leading-none relative z-10">
        ...
        <div className="w-full flex flex-col md:flex-row gap-8 lg:gap-16 items-center justify-center relative">
          ...
          <div className="w-full md:w-1/2 relative bg-[#E0E0E0] p-1 shadow-[12px_12px_0px_#00F0FF] transform transition-transform duration-300 hover:scale-105 hover:-rotate-2 group">
            ...
            <div className="bg-[#0A0A0A] border-4 border-[#00F0FF] border-dashed p-8 md:p-10 flex flex-col items-center text-center h-full">
              ...
              {/* Fake Barcode */}
              <div className="w-full h-12 mt-8 opacity-60" style={{
          ...
          <div className="w-full md:w-1/2 relative bg-[#E0E0E0] p-1 shadow-[12px_12px_0px_rgba(255,255,255,0.2)] hover:shadow-[12px_12px_0px_#00F0FF] transform transition-transform duration-300 hover:scale-105 hover:rotate-2 group z-10">
            ...
            <div className="bg-[#0A0A0A] border-4 border-[#E0E0E0] group-hover:border-[#00F0FF] p-8 md:p-10 flex flex-col items-center text-center h-full transition-colors duration-300">
              ...
              {/* Fake Barcode */}
              <div className="w-full h-12 mt-8 opacity-80" style={{
