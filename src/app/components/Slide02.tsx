...
export function Slide02() {
  return (
    <div className="relative min-h-screen bg-[#0A0A0A] flex flex-col md:flex-row overflow-hidden w-full">
      ...
      <div className="w-full md:w-[50%] flex flex-col justify-center bg-[#0A0A0A] p-6 sm:p-12 md:p-14 z-10 relative">
        <h2 className="font-['Inter_Tight',sans-serif] font-black text-5xl md:text-6xl text-[#FFFFFF] mb-8 uppercase leading-none tracking-tighter mix-blend-difference">
          The <span className="text-transparent" style={{ WebkitTextStroke: '2px #00F0FF' }}>Sonic</span> Snapshot
        </h2>

        <div className="flex flex-col gap-6 w-full font-['JetBrains_Mono',monospace]">

          {/* Box 1 */}
          <div className="border-[10px] border-[#FFFFFF] bg-[#0A0A0A] p-6 transform transition-transform hover:-translate-y-2 hover:border-[#00F0FF] duration-300 relative group">
