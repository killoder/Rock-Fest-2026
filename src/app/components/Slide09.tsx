export function Slide09() {
  return (
    <div className="relative min-h-[80vh] bg-[#0A0A0A] flex flex-col items-center justify-center overflow-hidden w-full font-['Inter_Tight',sans-serif] px-6 sm:px-12 md:px-24 py-24 border-[20px] md:border-[30px] border-[#00F0FF]">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 h-full items-center">
        ...
        <div className="w-full lg:w-[60%] flex flex-col justify-center">
          <div className="mb-12 border-l-8 border-[#00F0FF] pl-8">
            <h2 className="font-black text-[12vw] sm:text-[10vw] md:text-8xl lg:text-9xl text-[#FFFFFF] uppercase tracking-tighter leading-[0.85] mix-blend-difference mb-8">
              Ready <br/>
              To <span className="text-transparent" style={{ WebkitTextStroke: '3px #FFFFFF' }}>Partner</span><br/>
              Up?
            </h2>
          ...
          <p className="font-['JetBrains_Mono',monospace] text-[#FFFFFF] text-lg md:text-xl lg:text-2xl opacity-90 leading-relaxed max-w-2xl pl-8 border-l-2 border-[#FFFFFF]/20">
            Let's sit down and find the best way to get your brand in front of 4,000 fans. No fluff, just impact.
          </p>
        </div>
        ...
        <div className="w-full lg:w-[40%] flex flex-col justify-center bg-[#00F0FF] p-8 md:p-12 shadow-[16px_16px_0px_#FFFFFF] transform rotate-1 hover:rotate-0 transition-transform duration-300">
          ...
          <div className="flex flex-col gap-8 font-['JetBrains_Mono',monospace]">
            ...
            <div className="group border-l-4 border-[#0A0A0A] pl-4 hover:pl-6 transition-all duration-300">
              ...
              <a href="mailto:gfurxhi@gmail.com" className="text-lg md:text-xl font-bold text-[#0A0A0A] hover:underline decoration-4 underline-offset-4 tracking-wider break-all">
                gfurxhi@gmail.com
              </a>
            </div>
