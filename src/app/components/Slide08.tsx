...
export function Slide08() {
  return (
    <div className="relative min-h-screen bg-[#0A0A0A] flex flex-col justify-center overflow-hidden w-full font-['Inter_Tight',sans-serif] px-6 sm:px-12 md:px-24 py-16">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col md:flex-row gap-16 lg:gap-24 items-center h-full">
        {/* Left Side: Copy */}
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          <div className="mb-12 border-b-[8px] border-[#00F0FF] pb-6 inline-block w-fit">
            <h2 className="font-black text-6xl md:text-7xl lg:text-8xl text-[#FFFFFF] uppercase tracking-tighter leading-[0.9] mix-blend-difference">
              We Know <br/>
              <span className="text-transparent" style={{ WebkitTextStroke: '2px #FFFFFF' }}>The Stage.</span>
            </h2>
          </div>

          <div className="flex flex-col gap-10 font-['JetBrains_Mono',monospace]">
            {/* Box 1 */}
            <div className="group relative pl-6 border-l-4 border-[#FFFFFF] hover:border-[#00F0FF] transition-colors duration-300">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-[#00F0FF] mb-3 tracking-widest uppercase">
                // Proven Experience
              </h3>
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center gap-6">
          {/* Main Sponsor */}
          <div className="w-full bg-[#0A0A0A] border-[12px] border-[#00F0FF] flex flex-col items-center justify-center p-8 text-center group hover:border-[#FFFFFF] transition-colors duration-500 relative overflow-hidden shadow-[12px_12px_0px_rgba(0,240,255,0.4)]">
            ...
            <div className="relative z-10 flex flex-col items-center w-full">
              <span className="font-['JetBrains_Mono',monospace] text-[#00F0FF] group-hover:text-[#0A0A0A] text-xs md:text-sm font-bold tracking-[0.3em] uppercase mb-6 transition-colors duration-500">
                // Main Sponsor & Partner
              </span>
              
              <div className="w-full max-w-[240px] aspect-square relative mb-4">
                <ImageWithFallback
            ...
            <div className="aspect-square bg-[#0A0A0A] border-[6px] border-[#FFFFFF] flex items-center justify-center p-4 text-center group hover:border-[#00F0FF] transition-colors duration-300 relative overflow-hidden">
              ...
              <div className="relative z-10 w-full h-full flex items-center justify-center">
                <ImageWithFallback
                  ...
                  className="w-full h-full object-contain transition-transform duration-500 group-hover:scale-110 scale-90"
                />
              </div>
            </div>
